...
Section 1. A covered operator must file a notice. Section 2. The notice must identify the operator. [S1]
...
The operator is immune from every penalty once it files.
